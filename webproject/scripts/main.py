...
def run():
  ...
  Class(number="20214", title="역사철학",subnum="01", idnums='2021401', professor="김은주", downloadPath='/home/ec2-user/Downlodas/20214_01.csv', filename='역사철학_20214_01_김은주.csv', title="역사철학", crawled_time=datetime.now(),period_start="3:30 PM", period_end="4:45 PM", classroom='포356').save()
  df = pd.DataFrame()
